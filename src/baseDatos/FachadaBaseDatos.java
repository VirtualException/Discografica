...
public class FachadaBaseDatos {
    ...
    public FachadaBaseDatos (aplicacion.FachadaAplicacion fa){
        ...
        try {
            ...
            daopremios = new DAOPremios(conexion, fa);
    ...
    public List<Premiacion> obtenerPremio(String nombre, String institucion){
        return daopremios.obtenerPremio(nombre, institucion);
    }
    public void anadirPremio(String nombre, String institucion, LocalDate fecha, int tipoPremio, String nombrealbcan){
        List<Premiacion> premios = daopremios.obtenerPremio(nombre, institucion);
        if(premios.isEmpty()){
            daopremios.anadirPremio(nombre, institucion, fecha, tipoPremio, nombrealbcan);
        }else{
            //actualizar premios
            daopremios.actualizarPremio(nombre, institucion, fecha, tipoPremio, nombrealbcan);
        }
        
    }
    public void borrarPremio(String nombre, String institucion){
        daopremios.borrarPremio(nombre, institucion);
    }
}